...
function dxDrawBorderedText(outline, text, left, top, right, bottom, color, scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
	...
	local _, _, _, a = getColorFromString(color)

    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left - outlineX, top - outlineY, right - outlineX, bottom - outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left + outlineX, top - outlineY, right + outlineX, bottom - outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left - outlineX, top + outlineY, right - outlineX, bottom + outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left + outlineX, top + outlineY, right + outlineX, bottom + outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left - outlineX, top, right - outlineX, bottom, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left + outlineX, top, right + outlineX, bottom, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left, top - outlineY, right, bottom - outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
    dxDrawText(string.gsub(text, "#%x%x%x%x%x%x", "#000000"), left, top + outlineY, right, bottom + outlineY, tocolor (0, 0, 0, a), scaleX, scaleY, font, alignX, alignY, clip, wordBreak, postGUI, true, subPixelPositioning, fRotation, fRotationCenterX, fRotationCenterY)
